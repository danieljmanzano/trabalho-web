      ...
      <div className="flex-1 flex items-center justify-center">
        <section className="container mx-auto px-4 py-8 md:py-12">
          <div className="grid md:grid-cols-[1fr_1.5fr] gap-8 lg:gap-16 items-center max-w-6xl mx-auto">
            ...
            <div className="bg-surface p-6 sm:p-8 md:p-14 rounded-2xl md:rounded-[2.5rem] space-y-6 shadow-sm">
              <h1 className="font-serif text-3xl sm:text-4xl md:text-6xl font-bold text-surface-foreground leading-tight">
                Arquitetura com <span className="text-primary">excelência</span>
              </h1>

              <div className="space-y-4 md:space-y-6">
                <p className="text-lg md:text-xl text-surface-muted leading-relaxed font-medium">
                ...
                <p className="text-base md:text-lg text-surface-subtle/90 leading-relaxed">
              ...
              <div className="flex gap-4 pt-2 md:pt-4">
                <a
                  ...
                  className="inline-flex items-center justify-center w-10 h-10 md:w-12 md:h-12 bg-surface text-primary rounded-xl hover:bg-primary hover:text-primary-foreground transition-all shadow-sm border border-surface-border"
                  title="WhatsApp"
                >
